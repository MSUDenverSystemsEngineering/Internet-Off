...
Try {
	...
	[string]$appVendor = 'CrystalRich'
	[string]$appName = 'Internet Off'
	[string]$appVersion = '3.0'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '3.7.0.1'
	[string]$appScriptDate = '08/08/2019'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'internetoff,IOffSvc' -CheckDiskSpace -PersistPrompt

		## Show Progress Message (with the default message)
		Show-InstallationProgress

		## <Perform Pre-Installation tasks here>
		If (Test-Path -Path "$envProgramFilesX86\InternetOff\unins000.exe"){
			Execute-Process -Path "$envProgramFilesX86\InternetOff\unins000.exe" -Parameters '/verysilent /NORESTART' -WindowStyle 'Hidden'
		}
		...
		Execute-Process -Path "$dirFiles\internetoffsetup_3-0-1.exe" -Parameters '/verysilent /NORESTART' -WindowStyle 'Hidden'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'internetoff,IOffSvc' -CloseAppsCountdown 60
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDHeRQWD6rowgDF
# GrQbgZ5Sr5nBAnhTihTWLboZsfU8+KCCFFwwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgrdQq/OD2
# oWQriho7AqaGTiH/gh29VY8s1GRSNBkjmbswDQYJKoZIhvcNAQEBBQAEggEAN/nK
# vA3sCkZpQ7Iw4qH/qVAy4Q6v1t8iNQ7ipnAEsKJDPW/EFUrWKNFGWHpT3n2XP3r6
# UnXlkUkcOSKYau4fUzKHURDvR+Y6M1CTnxM9wSYOnPRL6K4eRAvFZOJkQJWB9W2n
# /PMyvjL3ronlHK5SuUOJmCz9WavZiokGEO8q4cX/QruhEuFq6pUTI9IDtkfZmSef
# 9ZnwUXCFiHSENCkRv193ErzuJfPl3w71Enrk/O0V8ztuM/zxX4FOdefI1x/zUhWH
# 0VNcksJdv2vr2aMgcNFR2wa4hHi/RYTQ6ZFe/ADzztiXCj00ObRwm+glWjnw65ky
# YzPRy7rrz3clVXXxnaGCAqIwggKeBgkqhkiG9w0BCQYxggKPMIICiwIBATBoMFIx
...
# CSqGSIb3DQEJBTEPFw0xOTA4MDgyMDAzNTVaMCMGCSqGSIb3DQEJBDEWBBTY2Xe4
# fwT/GBndK2o+9w32WGQH+TCBnQYLKoZIhvcNAQkQAgwxgY0wgYowgYcwgYQEFGO4
...
# ggEAYHeIMNxRUnTHJT4J+KtVDJKIDml7HyjSccIN0LIYvCILm6MI0/SGCJ+/jDUt
# B7+9g9B1GGwWUB2iAWp/HXdofsRIKM1COecPjc/LRcSev8ulu9z87D19Fb7zK5Pp
# 63XZof4md+ps80ZYD3UecSFyePREQRU78QUpUZm36HbDfBlxR+jMHDGyn/9VhRZN
# giX0Uw4eGNLB2zVKsesNk05y8Wa0NJmPLIkyPzK9AywMSv2Q+4BVC/Mgns7CrAVK
# 9dC92tSkBgRh5PrAMs4ac7c+j9JoPKI2VK49iz4lzzFFUAr+35NyhBlcC8BqmV66
# +km52grOFLdGWWj9wjygrvWN6w==
